        ...
        conditionalPanel(
          ...
          div(id = ns("mean_inputs"),
            ...
            div(class = "form-group",
                ...
                selectInput(ns("mean_alt"), label = NULL,
                  choices = c("\u03bc < \u03bc\u2080 (Left-tailed)" = "less",
        ...
        conditionalPanel(
          ...
          div(id = ns("prop_inputs"),
            ...
            div(class = "form-group",
                ...
                selectInput(ns("prop_alt"), label = NULL,
                  choices = c("p < p\u2080 (Left-tailed)" = "less",
    ...
    output$results_table <- renderDT({
      ...
      if (res$test_type == "mean") {
        datatable(data.frame(
          ...
          Value = c(res$mu0, res$mua, res$sigma, res$n, res$alpha,
        ...
        datatable(data.frame(
          ...
          Value = c(res$p0, res$pa, res$n, res$alpha,
                    if (percent) paste0(round(res$power * 100, rounding), "%") else round(res$power, rounding),
                    if (percent) paste0(round(res$beta * 100, rounding), "%") else round(res$beta, rounding))
        ), rownames = FALSE, options = list(dom = 't'))
      }
