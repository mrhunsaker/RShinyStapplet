...
var residualPlotVG = UI.makeVisibilityGroup("btnToggleResidualPlot",
                                            ...
                                            "btnToggleRegression",
                                            "btnExportResidPlot",                   "btnExportResidDotplot", "divResidualPlot", "divResidualDotplot");
...
function deactivatePage()
{
    UI.batchSetProperty(["spnExplanatoryMsg", "spnResponseMsg", "spnInferenceResults",
                         ...
                         "innerHTML", "");
    UI.batchSetStyleProperty(["divDisplayScatterplot", "divSummaryStatistics", "divInference", "cnvResidualDotplot", "btnExportPlot"],
                        "display", "none");
...
function beginAnalysis()
{
    ...
    {
        pageActive = true;
        UI.batchSetStyleProperty(["divDisplayScatterplot", "divSummaryStatistics", "divInference", "btnExportPlot"],
                        "display", "inline");
...
function updateResidualPlot(stats)
{
    ...
    residualPlot.scatterplot(util.arraysTo2DGraphData(xDataArr, stats.residuals,
		    ...
		    explanatoryVariableName(), "Residual", null, null, null, null, null, null, 5);
...
function updateScatterplot()
{
    ...
    UI.setStyleProperty("btnExportPlot", "display", "inline");
}

function exportSVG(divId,desc)
{
    file.saveSVG(document.getElementById("svg_" + divId), "quant2v_" + desc);
}
