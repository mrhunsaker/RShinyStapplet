...
function addCountsTableColumn()
{
    ...
    table.rows[0].insertCell(numDataColumns + 2).innerHTML = '<TD><INPUT TYPE="text" TITLE="Column Name" CLASS="colName" ID="txtCountsTblColName'
        + (numDataColumns + 2) + '" onChange="return deactivatePage(this)" onFocus="handleTableEntryFocus(this)" onBlur="handleTableEntryBlur(this,\'[group name]\')"  VALUE="[group name]" SIZE="15"></TD>';
...
{
	if (UI.getProperty("selInputType", "value") == "counts")
		return UI.getProperty("txtVariableNameCounts", "value");
	else
		return UI.getProperty("txtVariableNameRawData", "value");	
}
