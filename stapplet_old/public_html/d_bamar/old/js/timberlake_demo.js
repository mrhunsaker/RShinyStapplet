...
// 0 = SRS, 1 = Stratify row, 2 = Stratify column, 3 = Cluster, 4 = Systematic
var dataArrs = [null, null, null, null, null];
var graphDataArrs = [null, null, null, null, null];
var graphs = [null, null, null, null, null];
var samples = [null, null, null, null, null];
var meanSpanIds = ["spnMeanSRS", "spnMeanStratifyRow", "spnMeanStratifyColumn", "spnMeanCluster", "spnMeanSystematic"];
var tblIds = ["tblSRS", "tblStratifyRow", "tblStratifyColumn", "tblCluster", "tblSystematic"];
var graphDivIds = ["divSRSPlot", "divStratifyRowPlot", "divStratifyColumnPlot", "divClusterPlot", "divSystematicPlot"];
var divIds = ["divSRS", "divStratifyRow", "divStratifyColumn", "divCluster", "divSystematic"];
var btnIds = ["btnSRS", "btnStratifyRow", "btnStratifyColumn", "btnCluster", "btnSystematic"];
...
function revealRestart()
{
    ...
    for (var i = 0; i < 5; i++)
    {
        graphs[i].setMarker(trueMean, "mean", "#990000");
        for (var j = 0; j < 10; j++)
